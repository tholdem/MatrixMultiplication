...
title(['Rank ' num2str(r) ' Segre Manifold Product ARC'])
xlabel('iterations')
xlim([1 MaxIter])
...
saveas(fig,['C:\Users\bryan\Documents\GitHub\MatrixMultiplication\Experiments\figures\SegreARC_' num2str(r) '_fval.png'])
