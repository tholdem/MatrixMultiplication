...
static void main_cubicRegScript(double i,double num,double rank,float k,double errTol,double maxIts, char *outputDir);
...
static void main_cubicRegScript(double i,double num,double rank,float k,double errTol,double maxIts, char *outputDir)
{
  ...
  cubicRegScript(i, num, rank, k, errTol, maxIts, outputDir);
}
...
int main(int argc, const char * const argv[])
{
  ...
  main_cubicRegScript(i, num, rank, k, errTol, maxIts, outputDir);
