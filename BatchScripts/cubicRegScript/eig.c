...
void eig(const emxArray_real_T *A, emxArray_creal_T *V, emxArray_creal_T *D)
{
  ...
  if ((A->size[0] == 0) || (A->size[1] == 0)) {
    ...
    V->size[0] = A->size[0];
    V->size[1] = A->size[1];
    emxEnsureCapacity_creal_T(V, i18);
    j = A->size[0] * A->size[1];
    for (i18 = 0; i18 < j; i18++) {
      V->data[i18].re = A->data[i18];
      V->data[i18].im = 0.0;
    }
    ...
    D->size[0] = A->size[0];
    D->size[1] = A->size[1];
    emxEnsureCapacity_creal_T(D, i18);
    j = A->size[0] * A->size[1];
    for (i18 = 0; i18 < j; i18++) {
      D->data[i18].re = A->data[i18];
      D->data[i18].im = 0.0;
    }
    ...
    if (p) {
      ...
      b_A->size[0] = A->size[0];
      b_A->size[1] = A->size[1];
      emxEnsureCapacity_creal_T(b_A, i18);
      j = A->size[0] * A->size[1];
      for (i18 = 0; i18 < j; i18++) {
        b_A->data[i18].re = A->data[i18];
        b_A->data[i18].im = 0.0;
      }
      ...
      i18 = W->size[0];
      W->size[0] = A->size[1];
      emxEnsureCapacity_creal_T(W, i18);
      ...
      if ((int)info_t < 0) {
        ...
        for (i18 = 0; i18 < j; i18++) {
          i = V->size[0];
          for (i19 = 0; i19 < i; i19++) {
            V->data[i19 + V->size[0] * i18].re = rtNaN;
            V->data[i19 + V->size[0] * i18].im = 0.0;
          }
        }
      }
