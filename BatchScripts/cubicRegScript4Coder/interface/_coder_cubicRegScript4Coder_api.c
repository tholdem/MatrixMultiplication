 ...
 * File: _coder_cubicRegScript4Coder_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "cubicRegScript4Coder",              /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
 ...
 * Return Type  : void
 */
void cubicRegScript4Coder_api(const mxArray * const prhs[7], int32_T nlhs)
{
  real_T i;
  real_T num;
  real_T rank;
  ...
  cubicRegScript4Coder(i, num, rank, k, errThd, maxIts, outputDir);
}
 ...
 * Return Type  : void
 */
void cubicRegScript4Coder_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  cubicRegScript4Coder_xil_terminate();
}
 ...
 * Return Type  : void
 */
void cubicRegScript4Coder_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_cubicRegScript4Coder_api.c
 *
 * [EOF]
 */
